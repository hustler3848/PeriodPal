  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        {/* Filters Section - always part of the scroll */}
        ...
        <Tabs defaultValue="list" className="flex-1 flex flex-col">
          ...
          <TabsContent value="list" className="flex-1 flex flex-col">
            <LocationListHeader count={filteredLocations.length} />
...
// Header for the list view to avoid duplication
const LocationListHeader = ({ count }: { count: number }) => (
  <div className="p-4 flex justify-between items-center shrink-0 border-b bg-background">
